 ...
 * - chDrawable: the drawable used to drawable the background
 * - chDrawableLeft: the drawable used to drawable left edge of the background
 * - chDrawableMid: the drawable used to drawable for whole line
 * - chDrawableRight: the drawable used to drawable right edge of the background
 */
